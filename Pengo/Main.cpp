...
static void load()
{
    ...
    auto backgroundRenderPtr = backgroundRender.get();
    ...
    auto logoRenderPtr = logoRender.get();
    ...
    auto renderPtr = renderComponent.get();
    ...
    player1->AddComponent(std::make_unique<dae::PengoControllerComponent>(*player1, 100.f, 1, dae::KeyboardScheme::WASD));
    ...
    player2->AddComponent(std::make_unique<dae::PengoControllerComponent>(*player2, 200.f, 0, dae::KeyboardScheme::IJKL));
    ...
    auto player1LivesText = std::make_unique<dae::TextComponent>(
        *player1LivesObject, player1LivesRenderPtr, "Lives: 3", livesFont
    );
    ...
    auto player1LivesDisplay = std::make_unique<dae::HealthDisplayComponent>(
        *player1LivesObject, &player1HealthPtr->GetSubject(), player1LivesTextPtr
    );
    ...
    auto player1ScoreText = std::make_unique<dae::TextComponent>(
        *player1ScoreObject, player1ScoreRenderPtr,
        "Score: " + std::to_string(player1ScorePtr->GetScore()), livesFont
    );
    ...
    auto player1ScoreDisplay = std::make_unique<dae::ScoreDisplayComponent>(
        *player1ScoreObject, &player1ScorePtr->GetSubject(), player1ScoreTextPtr
    );
    ...
    auto player2LivesText = std::make_unique<dae::TextComponent>(
        *player2LivesObject, player2LivesRenderPtr, "Lives: 3", livesFont
    );
    ...
    auto player2LivesDisplay = std::make_unique<dae::HealthDisplayComponent>(
        *player2LivesObject, &player2HealthPtr->GetSubject(), player2LivesTextPtr
    );
    ...
    auto player2ScoreText = std::make_unique<dae::TextComponent>(
        *player2ScoreObject, player2ScoreRenderPtr,
        "Score: " + std::to_string(player2ScorePtr->GetScore()), livesFont
    );
    ...
    auto player2ScoreDisplay = std::make_unique<dae::ScoreDisplayComponent>(
        *player2ScoreObject, &player2ScorePtr->GetSubject(), player2ScoreTextPtr
    );
    ...
    auto controlsText = std::make_unique<dae::TextComponent>(
        *controlsObject, controlsRenderPtr,
